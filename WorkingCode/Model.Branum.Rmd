...
set.seed(1)
df.noNumeric <- data.frame(read.csv("/Users/michaelstephan/Desktop/SMU/spring 2020/Applied Statistics/Final Project/6372_Project_2/Data/bank-model input-no continuous.csv"))
head(df.noNumeric)
